...
namespace Game.Views
{
    ...
    public partial class BattleEquip : ContentPage
    {

        //a gineric view model of the character in the party
        readonly PlayerInfoModel ViewModel;
        ...
        //constructor
        public BattleEquip(PlayerInfoModel data)
        {
            InitializeComponent();
        ...
        public StackLayout GetItemToDisplay(ItemLocationEnum location)
        {
            ...
            var data = ViewModel.GetItemByLocation(location);
            if (data == null)
            {
