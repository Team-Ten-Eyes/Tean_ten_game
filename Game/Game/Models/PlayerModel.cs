...
namespace Game.Models
{
    ...
    public class PlayerModel<T> : BaseModel<T>
    {
        ...
        public int CalculateExperienceEarned(int damage)
        {
            ...
            int remainingHealth = Math.Max(CurrHealth - damage, 0); // Go to 0 is OK...
            double rawPercent = (double)remainingHealth / (double)CurrHealth;
        ...
        public bool LevelUp()
        {
            ...
            for (var i = LevelTableHelper.Instance.LevelDetailsList.Count - 1; i > 0; i--)
            {
                ...
                if (LevelTableHelper.Instance.LevelDetailsList[i].Experience <= Experience)
                {
                    ...
                    var OldCurrentHealth = CurrHealth;
                    ...
                    CurrHealth = (MaxHealth - (OldMaxHealth - OldCurrentHealth));
