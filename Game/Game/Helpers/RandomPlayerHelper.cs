...
namespace Game.Helpers
{
    public static class RandomPlayerHelper
    {
        ...
        public static string GetCharacterName()
        {
            ...
            List<String> FirstNameList = new List<String> { "Mike", "Michelle", "Jack", "Will", "Bob", "Courage", "Dani", "Mami", "Mari", "Ryu", "Hucky", "Peanut", "Sumi", "Apple", "Ami", "Honami", "Sonomi", "Pat", "Sakue", "Isamu" };
        ...
        /// <returns></returns>
        public static BaseCharacter GetRandomCharacter(int MaxLevel)
        {
            ...
            var rnd = DiceHelper.RollDice(1, CharacterViewModel.Instance.Dataset.Count);

            var result = new BaseCharacter(CharacterViewModel.Instance.Dataset.ElementAt(rnd - 1))
            {
