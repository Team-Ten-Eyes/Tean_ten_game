...
namespace UnitTests.Models
{
    ...
    public class BaseMonsterTests
    {
        ...
        {
            // Arrange
            var dataNew = new BaseMonster();
            dataNew.Attack = 2;
            dataNew.Id = "oldID";

            // Act
            var result = new BaseMonster(dataNew);
        ...
        [Test]
        public void BaseMonster_Set_Default_Should_Pass()
        {
            // Arrange
            ...
            Assert.AreEqual("EVIL_MIKE.png", result.ImageURI);
        ...
        [Test]
        public void BaseMonster_Update_Default_Should_Pass()
        {
            // Arrange
            var dataOriginal = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_Update_InValid_Null_Should_Fail()
        {
            // Arrange
            var dataOriginal = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_FormatOuput_Default_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public void BaseMonster_GetAttack_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetDefense_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetHealthCurrent_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_Head_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_Feet_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_Necklass_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_PrimaryHand_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_OffHand_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public void BaseMonster_GetItemByLocation_RightFinger_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public async Task BaseMonster_GetItemByLocation_Unknown_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public async Task BaseMonster_AddItem_Default_Should_Pass()
        {
            // Arrange
            var data = new BaseMonster();
        ...
        [Test]
        public async Task BaseMonster_GetItemBonus_Default_Attack_Should_Pass()
        {
            // Arrange
        ...
        [Test]
        public async Task BaseMonster_GetAttackTotal_Default_Attack_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
        ...
        [Test]
        public async Task BaseMonster_GetDefenseTotal_Default_Defense_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
        ...
        [Test]
        public async Task BaseMonster_GetDamageTotal_Default_Speed_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
        ...
        [Test]
        public async Task BaseMonster_GetDamageRollAttack_Default_Speed_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
        ...
        [Test]
        public async Task BaseMonster_GetDamageItemBonus_Default_Speed_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
        ...
        [Test]
        public async Task BaseMonster_GetDamageItemBonusString_Default_Speed_Should_Pass()
        {
            // Arrange
            // Add each model here to warm up and load it.
            Game.Helpers.DataSetsHelper.WarmUp();
