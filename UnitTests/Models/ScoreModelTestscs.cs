...
namespace UnitTests.Models
{
    ...
    public class ScoreModelTests
    {
        ...
        public void ScoreModel_Set_Default_Should_Pass()
        {
            ...
            result.MonsterModelDeathList = new List<PlayerInfoModel> { new PlayerInfoModel(new BaseMonster()) };
            result.CharacterModelDeathList = new List<PlayerInfoModel> { new PlayerInfoModel(new BaseCharacter()) };
