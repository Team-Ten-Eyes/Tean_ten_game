...
namespace Scenario
{
    ...
    public class BattlePageScenarioTests
    {
       ...
       //     page.EngineViewModel.Engine.CharacterList.Add(CharacterPlayerMike);
       ...
       //     page.EngineViewModel.Engine.CurrentDefender = page.EngineViewModel.Engine.PlayerList.Where(m => m.PlayerType == PlayerTypeEnum.Monster).FirstOrDefault();
       //     page.EngineViewModel.Engine.CurrentAttacker = page.EngineViewModel.Engine.PlayerList.Where(m => m.PlayerType == PlayerTypeEnum.Character).FirstOrDefault();
